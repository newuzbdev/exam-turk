      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-2">
          <div className="text-center mb-12">
            <Badge className="mb-6 bg-gradient-to-r from-red-500 to-red-600 text-white border-none text-lg">
          ...
          <div className="space-y-4 max-w-7xl mx-auto">
            <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-gray-100/50">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <div className="bg-gradient-to-br from-red-500 to-red-600 text-white w-12 h-12 rounded-2xl flex items-center justify-center font-bold text-xl">
                    1
                  </div>
                ...
                <div className="flex flex-col items-end">
                  <div className="text-red-500 font-bold text-3xl bg-red-50 px-4 py-2 rounded-xl">
                    C2
                  </div>
