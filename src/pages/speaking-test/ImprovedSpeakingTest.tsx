...
export default function ImprovedSpeakingTest() {
  ...
  const addExamBodyClass = () => {
    try {
      document.body.classList.add("exam-mode")
      // Allow scrolling on speaking test pages
  ...
  if (showSectionDescription && currentSection) {
    return (
      <motion.div
        className="h-screen-mobile overflow-y-auto"
        initial="initial"
        animate="animate"
      >
        {!micChecked ? (
  ...
  return (
    ...
    >
     ...
     <main className="flex flex-1 flex-col items-center justify-center min-h-0 w-full px-2 sm:px-4 md:px-8 pt-4 sm:pt-6 md:pt-8 pb-20 safe-area-bottom" style={{ overflow: 'visible' }}>
